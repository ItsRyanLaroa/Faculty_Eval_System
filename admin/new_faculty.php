					...
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="position" id="position" class="form-control form-control-sm" required>
								...
								<option value="Dean" <?php echo isset($position) && $position == 'Dean' ? 'selected' : '' ?>>Dean</option>
								<option value="Program Chair" <?php echo isset($position) && $position == 'Program Chair' ? 'selected' : '' ?>>Program Chair</option>
								<option value="Instructor" <?php echo isset($position) && $position == 'Instructor' ? 'selected' : '' ?>>Instructor</option>
								<option value="Lecturer" <?php echo isset($position) && $position == 'Lecturer' ? 'selected' : '' ?>>Lecturer</option>
								<option value="Researcher" <?php echo isset($position) && $position == 'Researcher' ? 'selected' : '' ?>>Researcher</option>
							</select>
						</div>
					</div>
					<div class="col-md-6">
