		...
		<div class="card-body">
			<form action="" id="manage_staff">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'index.php?page=staff_list'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
...
<script>
    ...
    $.ajax({
        url: 'save_staff.php', // Updated file name here
        ...
        success:function(resp){
            if(resp == 1){
                ...
                $('#msg').html("<div class='alert alert-danger'>Staff ID already exists.</div>");
                $('[name="staff_id"]').addClass("border-danger");
                end_load();
            }
        }
    });
